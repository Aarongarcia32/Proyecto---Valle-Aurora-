...
// La API Key sí debe seguir viniendo del .env (es sensible, no se hardcodea)
const API_KEY = import.meta.env.VITE_GOOGLE_MAPS_API_KEY

// Map ID ya incorporado directamente en el código
const MAP_ID = '6dcb9cc2f649c7b478add25b'
